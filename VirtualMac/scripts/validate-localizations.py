...
TECHNICAL_IDENTICAL_VALUES = {
    ...
    "6K Retina",
    "Build %@ · %@ · %@",
    "Could Not Expand Disk",
    "Current size: %llu GB. Enter a larger size. About %llu GB is free; the extra space is only used as the guest writes to it.",
    "Disk Expanded",
    "Enter a size larger than the current %llu GB.",
    "Expand",
    "Expand Storage",
    "Ethernet (%@)",
    ...
    "NAT: Share %@",
    "Shut Down First",
    "Shut down this Virtual Mac before expanding its disk.",
    "Start %@",
    "The disk can be expanded while the Virtual Mac is shut down. macOS grows its partition the next time it starts.",
    "The disk is now %llu GB. macOS grows the partition the next time this Virtual Mac starts.",
    "USB Keyboard",
    "USB Mouse",
    "Virtual Mac",
    "VPN",
